...
<p class = "descrip"><i>Must enter correct old genus!</i></p>

<form class = 'formstyle' action='' method = 'POST'>
Old genus: <input type='text' name='old'><br>
New genus: <input type='text' name='new'><br>
...
<?php
    ...
    {
        $db = new MyDB();
        $sql = "UPDATE FLOWERS SET GENUS = '$new' WHERE GENUS LIKE '$old'";
        $ret = $db->exec($sql);
        $db->close();
        echo "<p class = 'styled' > The flower's genus has been updated! </p>";
    }
    ?>
